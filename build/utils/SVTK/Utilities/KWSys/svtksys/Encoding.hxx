...
#ifndef svtksys_Encoding_hxx
#define svtksys_Encoding_hxx
...
namespace svtksys {
class svtksys_EXPORT Encoding
{
public:
  // Container class for argc/argv.
  class svtksys_EXPORT CommandLineArguments
  {
  public:
